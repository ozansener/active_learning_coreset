...
def train(hold_out, dev_name, sample, go_on,semi):
    ...
    with tf.Session(config=config) as sesh:
        robust_cifar_train = AdverserialTrainer(params.learning_rate, 0.1*params.learning_rate, dev_name,10)
        ...
        sum_writer = tf.summary.FileWriter("./dumps_adverserial__go_on_{}__sample_{}__hold_out_{}__{}/".format(go_on,sample,hold_out_s,str_v), sesh.graph)
