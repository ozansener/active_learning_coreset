...
def train(hold_out, dev_name, sample, batch_id,go_on):
    ...
    with tf.Session(config=config) as sesh:
        ...
        saver.restore(sesh, 'models/cifar10_go_on_{}_robust_{}_model_hold_out_{}__{}-{}'.format(False,sample,hold_out_s,str_v, batch_id))
        ...
        #pickle.dump({'f':f,'l':v,'gt_f':f_t,'gt_l':v_t}, open('chosen_100_data_{}_{}'.format(hold_out, sample), 'wb'))
